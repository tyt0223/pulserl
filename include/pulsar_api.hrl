...
-record('MessageMetadata',
        {producer_name :: iodata(),        % = 1
         ...
         compression = 'NONE' ::
             ...
             'SNAPPY' |
             integer() |
             undefined, % = 8, enum CompressionType
...
-record('CommandSubscribe',
        {topic :: iodata(),        % = 1
         ...
         subType ::
             ...
             'Failover' |
             'Key_Shared' |
             integer(), % = 3, enum CommandSubscribe.SubType
         ...
         initialPosition = 'Latest' ::
             ...
             'Earliest' |
             integer() |
             undefined, % = 13, enum CommandSubscribe.InitialPosition
...
-record('CommandLookupTopicResponse',
        {brokerServiceUrl :: iodata() | undefined, % = 1
         ...
         response ::
             ...
             'Failed' |
             integer() |
             undefined, % = 3, enum CommandLookupTopicResponse.LookupType
...
-record('CommandGetTopicsOfNamespace',
        {request_id :: non_neg_integer(), % = 1, 32 bits
         ...
         mode = 'PERSISTENT' ::
             ...
             'ALL' |
             integer() |
             undefined}). % = 3, enum CommandGetTopicsOfNamespace.Mode
...
-record('BaseCommand',
        {type ::
         ...
         redeliverUnacknowledgedMessages ::
             pulsar_api:'CommandRedeliverUnacknowledgedMessages'() | undefined, % = 20
         partitionMetadata :: pulsar_api:'CommandPartitionedTopicMetadata'() | undefined, % = 21
         partitionMetadataResponse ::
             pulsar_api:'CommandPartitionedTopicMetadataResponse'() | undefined, % = 22
         ...
         getLastMessageIdResponse ::
             pulsar_api:'CommandGetLastMessageIdResponse'() | undefined, % = 30
         ...
         getTopicsOfNamespaceResponse ::
             pulsar_api:'CommandGetTopicsOfNamespaceResponse'() | undefined, % = 33
         ...
         getOrCreateSchemaResponse ::
             pulsar_api:'CommandGetOrCreateSchemaResponse'() | undefined, % = 40
         ...
         addPartitionToTxnResponse ::
             pulsar_api:'CommandAddPartitionToTxnResponse'() | undefined, % = 53
         addSubscriptionToTxn :: pulsar_api:'CommandAddSubscriptionToTxn'() | undefined, % = 54
         addSubscriptionToTxnResponse ::
             pulsar_api:'CommandAddSubscriptionToTxnResponse'() | undefined, % = 55
         ...
         endTxnOnPartitionResponse ::
             pulsar_api:'CommandEndTxnOnPartitionResponse'() | undefined, % = 59
         endTxnOnSubscription :: pulsar_api:'CommandEndTxnOnSubscription'() | undefined, % = 60
         endTxnOnSubscriptionResponse ::
             pulsar_api:'CommandEndTxnOnSubscriptionResponse'() | undefined}). % = 61
